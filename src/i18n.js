...
export const TRANSLATIONS = {
  en: {
    ...
    loginFailed: 'Login failed. Check your credentials or approval status.',
    hostAccountPending: 'Your host account is pending ADM approval.',
    email: 'Email',
    password: 'Password',
    hostRequestAlreadyPending: 'A host request is already pending for this email.',
    hostRequestRejectedRecently: 'This email was rejected in the last 30 days. Please wait before retrying.',
    hostRequestCreateFailed: 'Unable to create host account.',
    hostRequestPath: 'Host request path',
    newHostRequest: 'Register a new host',
    joinExistingHost: 'Join an existing host',
    targetHostSearch: 'Existing host name or address',
    targetHostRequired: 'Select an existing host before sending your request.',
  ...
  'fr-CA': {
    ...
    loginFailed: 'Connexion échouée. Vérifiez vos accès ou votre statut.',
    hostAccountPending: 'Votre compte hôte est en attente d’approbation ADM.',
    email: 'Courriel',
    password: 'Mot de passe',
    hostRequestAlreadyPending: 'Une demande hôte est déjà en attente pour ce courriel.',
    hostRequestRejectedRecently: 'Ce courriel a été refusé dans les 30 derniers jours. Veuillez patienter.',
    hostRequestCreateFailed: 'Impossible de créer le compte hôte.',
    hostRequestPath: 'Type de demande hôte',
    newHostRequest: 'Enregistrer un nouvel hôte',
    joinExistingHost: 'Rejoindre un hôte existant',
    targetHostSearch: 'Nom ou adresse de l’hôte existant',
    targetHostRequired: 'Sélectionnez un hôte existant avant d’envoyer votre demande.',
